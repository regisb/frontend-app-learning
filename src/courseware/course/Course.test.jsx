...
describe('Course', () => {
  ...
  it('handles click to open/close notification tray', async () => {
    ...
    expect(screen.getByTestId('NotificationTray')).toBeInTheDocument();
  });
  ...
  it('handles sessionStorage from a different course for the notification tray', async () => {
    ...
    sessionStorage.setItem(`notificationTrayStatus.${courseMetadataSecondCourse.id}`, '"closed"');
    ...
    expect(sessionStorage.getItem(`notificationTrayStatus.${courseMetadataSecondCourse.id}`)).toBe('"closed"');
  });
